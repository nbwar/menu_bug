    ...
    UIView.animateWithDuration(duration, delay: 0.0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.8, options: nil, animations: {
      ...
      if (self.presenting){
        ...
        if(transitionContext.transitionWasCancelled()){
          ...
          // Adding this logic I was able to prevent the menu from taking up the full screen
          // However if you swipe right on when the menu is open it will still have the bug
